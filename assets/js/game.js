...
var startGame = function() {
    ...
    for (var i = 0; i < enemyNames.length; i++) {
        if (playerHealth > 0) {
        //let user know what round they are in, remember that arrays start at 0 so it needs to have a 1 added to it
            ...
            //pass the pickedEnemyName variable's valeu into the fight function, where it will assume the value of the enemyName parameter
...
var shop = function() {
    ...
    switch (shopOptionPrompt) {
        ...
        //call shop() againt o force player to pick a valid option
            shop();
            break;
    }
};
